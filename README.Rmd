...
You should be able to delete all files in the output folder and start with your raw ungraded data and be able to generate reports. Change the following line in the Second Script, to run a report on a different participant.
```bash
# --------------------------------------------------------------------------
