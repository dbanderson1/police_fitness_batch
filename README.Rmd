...
library(tinytex)
```
However, some users may need to install a full distribution of LaTeX, for tinytex to work. The following distros are recommended:
...
You should be able to delete all files in the output folder and start with your raw ungraded data and be able to generate reports. Change the following code (line 32) in the Second Script, to run a report on a different participant.
```bash
# --------------------------------------------------------------------------
