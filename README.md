...
├── README.Rmd
├── renv  # redirects R to use project library instead of gloabl 
├── renv.lock  # JSON file that records package names, exact versions, and sources
